...
class Utils:
    ...
    INGESTION_COLUMN_NAMES = {
        ...
        'extra_author_attributes.id': 'creator_id',
        ...
        'extra_author_attributes.url': 'creator_url',
        'extra_author_attributes.image_url': 'creator_image',
        'article_extended_attributes.youtube_views': 'youtube_views',
        'article_extended_attributes.youtube_likes': 'youtube_likes',
        'extra_author_attributes.short_name': 'creator_short_name',
